        ...
        train: function(data, labels, options) {
            ...
            if(x2){
                ...
                for(let i=0;i<this.data.length;i++){
                    ...
                    // app[i] = [Math.pow(this.data[i][0],2),this.data[i][1]];
                    app[i] = [Math.pow(this.data[i][0],2), this.data[i][1]];
                }
                this.data = app;
            }
            ...
            if(y2){
                let app = zeros(this.data.length);
                for(let i=0;i<this.data.length;i++){
                    // app[i] = [this.data[i][0],this.data[i][1],this.data[i][2],Math.pow(this.data[i][1],2)];
                    app[i] = [this.data[i][0],Math.pow(this.data[i][1],2)];
                }
                this.data = app;
            }
