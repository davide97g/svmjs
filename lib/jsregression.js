...
(function (jsr) {
    'use strict';
	let LinearRegression = function (config) {
        config = config || {};
    ...
    let LogisticRegression = function(import_config) {
    ...
    let MultiClassLogistic = function(import_config){
        let config = import_config || {};
        if(!config.alpha){
            config.alpha = 0.001;
        }
